...
'action' => isset($organization->id) ? route('organizations.update',
$organization->id)
:
...
@section('fields')
    <div class="row">
        ...
        {{-- logo --}}
        <x-adminlte-input-file name="logo" label="Logo" fgroup-class="col-sm-6"
            placeholder="Escolha um arquivo..." accept=".jpg,.jpeg,.gif,.png">
    ...
    <div class="row">
        ...
        @endphp
        <x-adminlte-select name="organization_type_id" label="Tipo de Instituição"
            fgroup-class="col-sm-6">
            <option></option>
    ...
    <div class="row">
        <x-email-input fgroup-class="col-md-6"
            value="{{ old('email', $organization->email ?? '') }}" />

        <x-adminlte-input type="text" name="website" label="Website"
            fgroup-class="col-sm-6"
