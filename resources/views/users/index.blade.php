@extends('adminlte::page') @section('title', 'Usuários')
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="profile">
                                    <option></option>
                                    <option value="admin" {{ (isset($inputs->
                                        profile) && $inputs->profile ==
                                        \App\Enums\ProfileType::ADMIN)?
                                    ...
                                    >
                                        profile) && $inputs->profile ==
                                        \App\Enums\ProfileType::ORGANIZATION)?
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status">
                                    <option></option>
                                    <option value="active" {{ (isset($inputs->
                                        status) && $inputs->status ==
                                        \App\Enums\StatusType::ACTIVE)?
                                        'selected' : '' }}>Ativo
                                    </option>
                                    <option value="inactive" {{ (isset($inputs->
                                        status) && $inputs->status ==
                                        \App\Enums\StatusType::INACTIVE)?
                                        'selected' : '' }}>Inativo
                                    </option>
                                </select>
                            </div>
