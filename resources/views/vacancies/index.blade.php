                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" data-placeholder="Selecione uma instituição"
                                        style="width: 100%;" name="organization_id" @if (!Auth::user()->isAdmin()) disabled @endif>
                                        <option></option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" data-placeholder="Selecione uma causa"
                                        style="width: 100%;" name="cause_id">
                                        <option></option>
                                        @foreach ($causes as $cause)
                                            <option value="{{ $cause->id }}"
                                                {{ isset($inputs->cause_id) && $inputs->cause_id == $cause->id ? 'selected' : '' }}>
                                                {{ $cause->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" data-placeholder="Selecione uma habilidade"
                                        style="width: 100%;" name="skill_id">
                                        <option></option>
                                        @foreach ($skills as $skill)
                                            <option value="{{ $skill->id }}"
                                                {{ isset($inputs->skill_id) && $inputs->skill_id == $skill->id ? 'selected' : '' }}>
                                                {{ $skill->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" data-placeholder="Selecione um estado"
                                        style="width: 100%;" name="address_state">
                                        <option></option>
                                        @foreach ($states as $state)
                                            <option value="{{ $state->abbr }}"
                                                {{ isset($inputs->address_state) && $inputs->address_state == $state->abbr ? 'selected' : '' }}>
                                                {{ $state->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" data-placeholder="Selecione uma cidade"
                                        style="width: 100%;" name="address_city">
                                        <option></option>
                                        @if (isset($inputs->address_state) && $inputs->address_state !== null)
                                            ...
                                            @foreach ($state->cities as $city)
                                                <option value="{{ $city->id }}"
                                                    {{ isset($inputs->address_city) && $inputs->address_city == $city->id ? 'selected' : '' }}>
                                                    {{ $city->name }}
                                                </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type">
                                        ...
                                        <option value="recurrent"
                                            {{ isset($inputs->type) && $inputs->type == \App\Enums\RecurrenceType::RECURRENT ? 'selected' : '' }}>
                                            Recorrente</option>
                                        <option value="unique_event"
                                            {{ isset($inputs->type) && $inputs->type == \App\Enums\RecurrenceType::UNIQUE_EVENT ? 'selected' : '' }}>
                                            Evento Único</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            @foreach ($vacancies as $vacancy)
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge badge-{{ $vacancy->status == \App\Enums\StatusType::ACTIVE ? 'success' : 'danger' }}">
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-danger btn-sm" data-toggle="modal"
                                                ...
                                                onclick="deleteData('vacancies',{{ $vacancy->id }})">
